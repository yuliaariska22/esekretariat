...
<!-- Example DataTables Card-->
      <div class="container">
 <a href="<?php echo base_url()?>barangpersediaan/tambahdetailpengadaan/<?php echo $hasilparsing; ?>" class="btn btn-primary" style="margin-bottom: 10px;"><i class="fa fa-plus">Tambah Barang</a></i>
 <div class="card mb-3">
          ...
          <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th>Satuan</th> 
                        <th>Harga SSH</th>                        
                        <th>Total Harga SSH</th>
                        <th>Harga Rekanan</th> 
                        <th>Total Harga Rekanan</th> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right"><?= 'Rp'.number_format(($item->total_barang_in)*($item->hargasatuanrekanan),0,'.','.');?></td>
                         <td align="center"> <a href="<?php echo base_url()?>barangpersediaan/updatedetailpengadaan/<?php echo $item->id_detailmutasisementara;?>/<?php echo $hasilparsing?>" class="btn btn-warning" role="button">Edit</a></td>
                        <td align="center"> <a href="<?php echo base_url()?>barangpersediaan/hapusdetailpengadaan/<?php echo $item->id_detailmutasisementara;?>/<?php echo $hasilparsing?>" onclick="return confirm('Apakah anda yakin?');"class="btn btn-danger" role="button">Delete</a></td>
                    </tr>
                    <?php
                            $no++;
                    }
