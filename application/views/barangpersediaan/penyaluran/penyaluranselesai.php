          ...
          <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            <tbody  class="text-center">
                ...
                <?php 
                  ...
                  <td> 
                    <a href="<?php echo base_url()?>barangpersediaan/detailpenyaluranselesai/<?php echo $data->id_mutasi; ?>" class="btn btn-warning" style="margin-bottom: 1px;">List Order<i class="fa fa-tag"></i></a>
                   </td> 
                </tr>
                    <?php
                      $i++;
