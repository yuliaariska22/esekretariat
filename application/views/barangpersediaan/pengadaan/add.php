...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active"> Menambah Pengajuan Pengadaan</li>
      </ol>
<!-- Example DataTables Card-->
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Menambah Pengajuan Pengadaan</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url('barangpersediaan/action_menambahdatapengadaan')?>" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <option>Silahkan Pilih Nama Rekanan</option>
                        <?php 
                        $id_rekanan = $this->db->query("SELECT * FROM tbl_rekanan");
