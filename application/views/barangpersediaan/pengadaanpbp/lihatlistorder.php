...
<section id="services" class="services">
      ...
      <ol class="breadcrumb" >
        <li class="breadcrumb-item">
          <a href="<?php echo base_url('barangpersediaan/pengadaanpbp')?>">Konfirmasi Penerimaan Barang</a>
        </li>
          ...
          <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="right"><?= 'Rp'.number_format(($item->total_barang_in)*($item->hargasatuanrekanan),0,'.','.');?></td> </tr>
                    <?php
                            $no++;
                    }
                    ?>
