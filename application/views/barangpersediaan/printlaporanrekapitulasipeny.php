...
<table border="1" align="center">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td align="center"><?= $item->saldo_awal_in-$item->saldo_awal_out;?></td>
                        ...
                        <td align="center"><?= $item->saldo_awal_in-$item->saldo_awal_out+$item->pembelian-$item->pengeluaran;?></td>
                        <td align="right"><?= 'Rp. '.number_format($harga_satuan_barang_saldo_akhir);?></td>
                        <td align="right"><?= 'Rp. '.number_format($total_harga_saldo_awal+$total_harga_in-$total_harga_out);?></td>
                        <td></td>
                ...
                <tr>
                        ...
                        <td colspan="3" align="center"><?='Rp. '.number_format( $grand_total_harga_saldo_awal); ?></td>
                        ...
                        <td colspan="3" align="center"><?='Rp. '.number_format($grand_total_harga_saldo_akhir );?></td>
                        <td></td>
                </tr>
