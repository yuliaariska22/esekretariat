...
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Edit List Barang</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo base_url()?>barangpersediaan/simpan_updatedetailpenyaluran/<?php echo $hasilparsing; ?>/<?php echo $ambil->id_detailmutasisementara; ?>" method="post" enctype="multipart/form-data">
