...
<h1 class="jarak-lh" align="center"><?= $penyaluran->nama_opd ?></h1>
<p class="jarak-lh" align="center"><?= $penyaluran->alamat_kop_opd ?></p>
<p class="jarak-lh" align="center"><?= $penyaluran->kecamatan_opd ?></p>
<td>
</tr>
<tr>
<td colspan=3>
...
<table border="1" align="center" style="width:100%">
                ...
                <?php
                    ...
                    ?>
                    <tr>
                        <td align="center"><?php echo date("d/m/Y", strtotime($penyaluran->tanggal_bapenyaluranbarang)); ?></td>
                        <td><?= $item->Namabarang_ssh;?></td>
                        <td align="center"><?= $item->total_barang_out;?></td>
                        <td align="right"><?= number_format($item->hargasatuanrekanan,0,'.','.'); ?></td>
                        <td align="right"><?= number_format($item->total_barang_out*$item->hargasatuanrekanan,0,'.','.'); ?></td>
...
<footer>
            <table  align="right">
<tr><td>Dibuat di Padangsidimpuan, <?php echo $tanggalsurat; ?> <?php echo $bulannama;?> <?php echo $tahunsurat;?></td></tr>
</table>
<br><br>
<table  align="left">
...
<tr height="75px"></tr><td>(<?= $pbp->nama ?>)</td></tr>
<tr><td>NIP. <?= $pbp->nip ?></td></tr></table>
...
<tr height="75px"></tr><td align="center">&nbsp &nbsp (<?= $pejabatpenatausahaanbarang->nama ?>)</td></tr>
<tr><td align="center">&nbsp &nbspNIP. <?= $pejabatpenatausahaanbarang->nip ?></td></tr>
</table>
</footer>
</div>
