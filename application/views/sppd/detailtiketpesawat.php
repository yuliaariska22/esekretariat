...
?>
  ...
  <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Data Tiket Pesawat</li>
      </ol>
<!-- Example DataTables Card-->
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Data Tiket Pesawat</div>
        <div class="card-body">
       ...
       <div class="form-row">
          ...
          <div class="col-md-4">
            ...
            <select class="form-control form-control-sm" id="bukti_pembayaran" name="bukti_pembayaran" required />
                    <option value="<?= $data->bukti_pembayaran?>"><?= $data->bukti_pembayaran?></option>
