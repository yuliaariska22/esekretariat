       ...
       <div class="form-row">
          <div class="col-md-4">
            <label><b>No BKU</b></label>
             <input class="form-control" id="no_bku" type="text" aria-describedby="nameHelp" name="no_bku"/>
          </div>
       </div>
      </div>
       ...
       <div class="form-row">
          ...
          <div class="col-md-4">
            <label>Uang Harian</label>
             <input class="form-control" id="uangharian" type="text" aria-describedby="nameHelp" name="uangharian"/>
          </div>
          
          <div class="col-md-4">
            <label>Representasi</label>
             <input class="form-control" id="representasi" type="text" aria-describedby="nameHelp" name="representasi"/>
          </div>
       </div>
      </div>
       ...
       <div class="form-row">
          ...
          <div class="col-md-4">
            <label>Tiket Angkutan Darat</label>
             <input class="form-control" id="tiket_angkutan_darat" type="text" aria-describedby="nameHelp" name="tiket_angkutan_darat"/>
          </div>
          
          <div class="col-md-4">
            <label>Taxi</label>
             <input class="form-control" id="representasi" type="taxi" aria-describedby="nameHelp" name="taxi"/>
          </div>
       </div>
      </div>
       ...
       <div class="form-row">
          ...
          <div class="col-md-4">
            <label>Biaya Kontribusi</label>
             <input class="form-control" id="biaya_kontribusi" type="text" aria-describedby="nameHelp" name="biaya_kontribusi"/>
          </div>
