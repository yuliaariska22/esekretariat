...
?>
  ...
  <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Rekapitulasi Pembayaran Transpotasi Udara</li>
      </ol>
             <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-print"></i> Rekapitulasi Pembayaran Transpotasi Udara</div>
        <div class="card-body">
          <div class="table-responsive">
  <div class="container">
  <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>sppd/cetakrekapitulasisppdtransportasiudara">
