...
<h1 class="jarak-lh" align="center"><?= $pengadaan->nama_opd ?></h1>
...
<body>
<p class="jarak-lh" align="center"><u><b>SURAT PERINTAH PENGELUARAN/PENGADAAN BARANG </u></b></p>
<p class="jarak-lh" align="center">Nomor : <?php echo $pengadaan->no_sppb; ?></p>
<table>
...
<p>Harap dikeluarkan dari Gudang dan disalurkan barang tersebut dalam daftar dibawah ini untuk <?php echo $pengadaan->untuk; ?><p>
...
<tr height="75px"></tr><td align="left">(<?php echo $penggunaanggaran->nama; ?>)</td></tr>
<tr><td align="left">NIP. <?php echo $penggunaanggaran->nip; ?></td></tr>
</footer>
<div>
