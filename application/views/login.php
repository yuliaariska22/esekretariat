			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4"></h3>
						<form action="<?php echo base_url('login/action_login'); ?>" class="login-form"  method="post">
		      		<div class="form-group">
		      			<input type="text" class="form-control rounded-left" placeholder="NIP" name="nip" required>
		      		</div>
	            <div class="form-group d-flex">
	              <input type="password" class="form-control rounded-left" placeholder="Kata Sandi" name="password" required>
	            </div>
