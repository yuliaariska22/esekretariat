...
?>
  ...
  <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Laporan Daftar Tanah</li>
      </ol>
<!-- Example DataTables Card-->
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Laporan Daftar Tanah</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">
        <form action="<?php echo base_url()?>aset/printlaporandaftarkiba/" method="post" enctype="multipart/form-data">
