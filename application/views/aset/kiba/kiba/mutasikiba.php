...
?>
  ...
  <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Mutasi Data KIB A</li>
      </ol>
<!-- Example DataTables Card-->
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Mutasi Data KIB A</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">

        <form action="<?php echo config_item('base_url'); ?>/aset/action_mutasidatakiba/<?= $data->id_riwayat_kiba?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_riwayat_kiba"  value="<?= $data->id_riwayat_kiba?>" />
