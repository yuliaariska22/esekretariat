...
?>
  ...
  <ol class="breadcrumb" >
        ...
        <li class="breadcrumb-item active">Laporan Hilang</li>
      </ol>
<!-- Example DataTables Card-->
<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-plus"></i> Laporan Hilang</div>
        <div class="card-body">
          <div class="table-responsive">
             <div class="container">
        <form action="<?php echo base_url()?>aset/printlaporanhilang/" method="post" enctype="multipart/form-data">
